Result<template lang="html">
  <div>
    <h1>{{msg}}</h1>
    <router-link :to="{path: '/pregnancy'}">Back to herd preg-check information</router-link>
    ...
    <div class="tab-content" id="myTabContent">
      ...
      <div class="tab-pane fade" id="delete" role="tabpanel" aria-labelledby="delete-tab">
        <div class="form-group">
          <h5> Delete</h5>
          <button class="btn btn-danger" type="button" @click="deletePregCheck()" name="deletePregCheckEvent">Delete this preg-check event</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  data() {
    return {
      msg: 'Edit this preg-check event',
      pregCheck: [],
      cows: []
    }
  },
