<template lang="html">
  <div>
    <h1>{{msg}}</h1>
    <router-link :to="{path: '/calving'}">Back to herd calving information</router-link>
    ...
    <div class="tab-content" id="myTabContent">
      ...
      <div class="tab-pane fade" id="delete" role="tabpanel" aria-labelledby="delete-tab">
        <div class="form-group">
          <h5> Delete</h5>
          <button class="btn btn-danger" type="button" @click="deleteCalving()" name="deleteCalvingEvent">Delete this calving event</button>
        </div>
      </div>
    </div>
  </div>
